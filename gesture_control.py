...
ser = serial.Serial("COM5", 9600)  # 波特率9600
...
OPEN_HAND_THRESHOLD = 0.16  # 张开手掌的阈值
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            mp_drawing.draw_landmarks(
                canvas, hand_landmarks, mp_hands.HAND_CONNECTIONS  # 改为在canvas上绘制,
            )
